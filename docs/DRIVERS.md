...
If you need a kernel module not included in the pre-built set, refer to the [Kernel Module Build Guide](../KERNEL_MODULE_BUILD_GUIDE.md) for cross-compilation instructions. Key points:
