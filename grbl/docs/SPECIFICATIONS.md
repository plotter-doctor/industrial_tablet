...
Detailed spec sheet for the 7" Industrial Touch Panel — GRBL CNC Controller.
...
| **WebView** | Chrome 119 |
| **GRBL Controller** | Full-featured GRBL sender (USB serial) |
| **Serial USB Terminal** | Raw serial monitor/debug |
| **ser2net Bridge** | TCP:8023 ↔ /dev/ttyUSB0 @ 115200 |
| **Boot Mode** | Auto-start GRBL Controller + ser2net + kiosk mode |
