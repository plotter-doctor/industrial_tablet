...
Detailed spec sheet for the 7" Industrial Touch Panel — HMI Pro.
...
| **WebView** | Chrome 119 |
| **Virtuino 6** | IoT/PLC dashboard builder |
| **TeslaModbusSCADA** | Modbus TCP/RTU SCADA client |
| **TeslaMultiSCADA** | Multi-protocol SCADA client |
| **Boot Mode** | Auto-start HMI dashboard + kiosk mode |
