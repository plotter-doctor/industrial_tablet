...
Detailed spec sheet for the 7" Industrial Touch Panel — Arduino Workbench.
...
| **WebView** | Chrome 119 |
| **RoboRemo Free** | Custom remote UI over WiFi/BT/USB |
| **RemoteXY Free** | Arduino GUI builder |
| **Serial USB Terminal** | USB serial monitor/debug |
| **Boot Mode** | Auto-start app + kiosk mode |
