...
Detailed spec sheet for the 7" Industrial Touch Panel — Weather & Calendar Dashboard.
...
| **Brightness Range** | 0–255 (pre-set to maximum for dashboard visibility) |
...
| **WebView** | Chrome 119 |
| **Weawow** | Weather dashboard (primary) |
| **Pearl Weather** | Weather widget (alternative) |
| **Etar Calendar** | Calendar app with CalDAV sync |
| **Tasks.org** | Task planner |
| **Boot Mode** | Auto-start Weawow + kiosk mode |
